...
# Language display names live in the canonical module so the CLI, the API's
# /settings/supported-languages endpoint, and transcript routes share one
# source of truth (DRY). Update names there, not here.
from chronovista.models.language_names import (  # noqa: E402
    LANGUAGE_NAMES,  # noqa: F401 — re-exported for CLI callers and tests
    get_language_name,
)
