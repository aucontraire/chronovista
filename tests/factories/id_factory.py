...
class YouTubeIdFactory:
    ...
    def create_channel_id(seed: Optional[str] = None) -> str:
        ...
        if seed:
            ...
            hash_value = ''.join(random.choices(string.ascii_letters + string.digits, k=22))
...
class TestIds:
    ...
    # Videos
    NEVER_GONNA_GIVE_YOU_UP = YouTubeIdFactory.create_video_id("never_gonna_give_you_up")
