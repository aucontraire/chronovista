...
def create_entity(
    name: str = typer.Argument(
        ..., help="Canonical name for the entity (e.g., 'Ada Lovelace')."
    ),
...
def add_exclusion(
    ...
    detection. For example, adding 'New Peru' as an exclusion on the 'Peru'
    entity ensures that 'New Peru' segments are not counted as mentions of Peru.
    """
