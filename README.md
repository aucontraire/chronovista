...
- **Tag canonicalization** — a 9-step Unicode pipeline (case, accent, and hashtag folding) collapses raw tag variants into canonical forms while preserving semantic distinctions (Peru ≠ Mexican), with fuzzy trigram search, alias tracking, and reversible curation (merge / split / classify / deprecate)
