...
class TestMultipleAliases:
    ...
    async def test_canonical_and_aliases_all_match(
        ...
        await _seed_segment(
            db_session, video_id(seed="ma_001"), text="Edsger Dijkstra spoke at the conference", sequence_number=0
        )
        await _seed_segment(
...
class TestCorrectedSegmentText:
    ...
    async def test_corrected_text_used_when_has_correction_true(
        ...
        await _seed_entity(db_session, "Edsger Dijkstra", entity_type="person")
...
class TestASRErrorAliasCounterExclusion:
    ...
    async def test_canonical_name_mention_included_in_mention_count(
        ...
        Setup:
        - Entity "Edsger Dijkstra" (canonical name)
        - Segment text contains "Edsger Dijkstra"
        ...
        await _seed_segment(
            db_session,
            vid,
            text="Edsger Dijkstra is the CEO of SpaceX",
        )
        entity = await _seed_entity(db_session, "Edsger Dijkstra", entity_type="person")
