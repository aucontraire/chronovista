 ...
 * detection. For example, entity "Peru" might have exclusion pattern
 * "New Peru" so "New Peru" doesn't get flagged as a "Peru" mention.
 *
 * Features:
    ...
    <section aria-labelledby="entity-exclusion-patterns-heading" className="mb-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <p className="text-xs text-gray-500 mb-3">
          ...
          entity. For example, "New Peru" can be excluded so it doesn't
          count as a "Peru" mention.
        </p>
