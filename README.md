...
chronovista tags merge mejico mexiko --into peru  # Merge spelling variants
chronovista tags split peru --aliases "Mexican"   # Split incorrectly merged tags
chronovista tags rename peru --to "Peru"        # Change display form
chronovista tags classify peru --type place       # Assign entity type
chronovista tags classify "river" --link-entity "Peter Naur"  # Link tag to existing entity
...
```bash
chronovista entities create "Redacted" --type person  # Create entity
