...
class TestUserVideoBaseFactory:
    ...
    def test_user_video_base_creation(self):
        ...
        user_video = UserVideoBaseFactory()
    ...
    def test_user_video_base_custom_values(self):
        ...
        custom_user_video = UserVideoBaseFactory(
            user_id="custom_user",
    ...
    def test_user_video_base_valid_user_ids(self, valid_user_id):
        ...
        user_video = UserVideoBaseFactory(user_id=valid_user_id)
    ...
    def test_user_video_base_invalid_user_ids(self, invalid_user_id):
        ...
        with pytest.raises(ValidationError):
            UserVideoBaseFactory(user_id=invalid_user_id)
    ...
    def test_user_video_base_valid_video_ids(self, valid_video_id):
        ...
        user_video = UserVideoBaseFactory(video_id=valid_video_id)
    ...
    def test_user_video_base_invalid_video_ids(self, invalid_video_id):
        ...
        with pytest.raises(ValidationError):
            UserVideoBaseFactory(video_id=invalid_video_id)
    ...
    def test_user_video_base_valid_completion_percentages(self, valid_percentage):
        ...
        user_video = UserVideoBaseFactory(completion_percentage=valid_percentage)
    ...
    def test_user_video_base_invalid_completion_percentages(self, invalid_percentage):
        ...
        with pytest.raises(ValidationError):
            UserVideoBaseFactory(completion_percentage=invalid_percentage)
...
class TestUserVideoCreateFactory:
    ...
    def test_user_video_create_creation(self):
        ...
        user_video = UserVideoCreateFactory()
...
class TestUserVideoUpdateFactory:
    ...
    def test_user_video_update_creation(self):
        """Test basic UserVideoUpdate creation from factory."""
        user_video_update = UserVideoUpdateFactory()
...
class TestUserVideoFactory:
    ...
    def test_user_video_timestamps(self):
        ...
        user_video = UserVideoFactory(created_at=created_time, updated_at=updated_time)
...
class TestGoogleTakeoutWatchHistoryItemFactory:
    ...
    def test_google_takeout_item_creation(self):
        ...
        takeout_item = GoogleTakeoutWatchHistoryItemFactory()
    ...
    def test_google_takeout_item_valid_urls(self, valid_url):
        ...
        takeout_item = GoogleTakeoutWatchHistoryItemFactory(titleUrl=valid_url)
    ...
    def test_google_takeout_item_invalid_urls(self, invalid_url):
        ...
        with pytest.raises(ValidationError):
            GoogleTakeoutWatchHistoryItemFactory(titleUrl=invalid_url)
    ...
    def test_google_takeout_item_valid_titles(self, valid_title):
        ...
        takeout_item = GoogleTakeoutWatchHistoryItemFactory(title=valid_title)
    ...
    def test_google_takeout_item_invalid_titles(self, invalid_title):
        ...
        with pytest.raises(ValidationError, match="Title cannot be empty"):
            GoogleTakeoutWatchHistoryItemFactory(title=invalid_title)
    ...
    def test_google_takeout_item_extract_video_id_edge_cases(self):
        ...
        item4 = GoogleTakeoutWatchHistoryItemFactory(
    ...
    def test_google_takeout_item_extract_channel_info_edge_cases(self):
        ...
        item1 = GoogleTakeoutWatchHistoryItemFactory(subtitles=[])
        assert item1.extract_channel_info() is None

        # Test with malformed subtitle data
        item2 = GoogleTakeoutWatchHistoryItemFactory(subtitles=[{"invalid": "data"}])
    ...
    def test_google_takeout_item_extract_channel_id(self):
        ...
        item2 = GoogleTakeoutWatchHistoryItemFactory(subtitles=[])
    ...
    def test_google_takeout_item_get_watch_action(self):
        ...
        # Test "watched" action
        item1 = GoogleTakeoutWatchHistoryItemFactory(title="Watched Test Video")
        assert item1.get_watch_action() == "watched"

        # Test "viewed" action
        item2 = GoogleTakeoutWatchHistoryItemFactory(title="Viewed Python Tutorial")
        assert item2.get_watch_action() == "viewed"

        # Test "visited" action
        item3 = GoogleTakeoutWatchHistoryItemFactory(title="Visited Channel Page")
        assert item3.get_watch_action() == "visited"

        # Test unknown action
        item4 = GoogleTakeoutWatchHistoryItemFactory(title="Some Random Title")
    ...
    def test_google_takeout_item_get_video_title(self):
        ...
        item3 = GoogleTakeoutWatchHistoryItemFactory(title="Visited Tech Channel")
        assert item3.get_video_title() == "Tech Channel"

        # Test title with no prefix
        item4 = GoogleTakeoutWatchHistoryItemFactory(title="Regular Video Title")
    ...
    def test_google_takeout_item_to_user_video_create_edge_cases(self):
        ...
        item2 = GoogleTakeoutWatchHistoryItemFactory(time="invalid-timestamp")
        ...
        item3 = GoogleTakeoutWatchHistoryItemFactory(time="2023-12-01T15:30:45Z")
...
class TestUserVideoSearchFiltersFactory:
    ...
    def test_user_video_search_filters_creation(self):
        ...
        filters = UserVideoSearchFiltersFactory()
    ...
    def test_user_video_search_filters_partial(self):
        ...
        filters = UserVideoSearchFiltersFactory(
            user_ids=["single_user"], liked_only=None, disliked_only=None
        )
...
class TestUserVideoStatisticsFactory:
    ...
    def test_user_video_statistics_creation(self):
        ...
        stats = UserVideoStatisticsFactory()
...
class TestBatchOperations:
    ...
    def test_factory_inheritance_behavior(self):
        ...
        base_video = UserVideoBaseFactory()
        create_video = UserVideoCreateFactory()
        full_video = UserVideoFactory()
...
class TestValidationEdgeCases:
    ...
    def test_boundary_values(self):
        ...
        min_video = UserVideoBaseFactory(
        ...
        max_video = UserVideoBaseFactory(
...
class TestAdditionalValidationEdgeCases:
    ...
    def test_user_video_update_selective_fields(self):
        ...
        update = UserVideoUpdate(completion_percentage=75.0, liked=True)
    ...
    def test_completion_percentage_comprehensive_validation(self, invalid_completion):
        ...
        with pytest.raises(ValidationError):
            UserVideoCreateFactory(completion_percentage=invalid_completion)

        # Test in UserVideoUpdate
        with pytest.raises(ValidationError):
            UserVideoUpdateFactory(completion_percentage=invalid_completion)
    ...
    def test_google_takeout_comprehensive_url_validation(self):
        ...
        for url in valid_urls:
            item = GoogleTakeoutWatchHistoryItemFactory(titleUrl=url)
