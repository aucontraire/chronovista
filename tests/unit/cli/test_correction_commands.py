...
class TestCrossSegmentDryRunDisplay:
    ...
    def test_cross_segment_dry_run_type_column_markers(
        ...
        mock_previews = [
            ("vid001", 156, 342.0, "Katherine Johnsen", "Katherine Johnson"),
            ("vid001", 157, 345.0, "Bound también", "también siendo"),
            ("vid002", 42, 123.0, "eml said", "EML said"),
        ]
    ...
    def test_cross_segment_dry_run_summary_zero_pairs(
        ...
        mock_previews = [
            ("vid001", 10, 50.0, "eml said hello", "EML said hello"),
            ("vid002", 20, 100.0, "eml spoke again", "EML spoke again"),
        ]
