...
def _make_video_row(
    ...
    title: str = "Ada Lovelace Interview",
    description: str | None = "In this interview, Ada Lovelace discusses linguistics.",
...
class TestScanMetadataTitle:
    ...
    async def test_t014_title_scan_applies_exclusion_patterns(self) -> None:
        ...
        title 'New Peru Travel Guide' for entity 'Peru'.
        """
        entity_id = _make_uuid()
        entity = _make_entity_row(
            entity_id=entity_id,
            canonical_name="Peru",
            exclusion_patterns=["New Peru"],
        )
        video = _make_video_row(
            video_id="vid00200002",
            title="New Peru Travel Guide",
        )
        ...
        # No mentions should be created because "Peru" is inside "New Peru"
    ...
    async def test_title_scan_dry_run_collects_previews(self) -> None:
        ...
        video = _make_video_row(
            ...
            title="Ada Lovelace Discusses Linguistics",
        )
    ...
    async def test_title_scan_with_aliases(self) -> None:
        ...
        alias = _make_alias_row(entity_id, "Moreau Obrador")
        video = _make_video_row(
            video_id="vid00600006",
            title="Moreau Obrador Speaks at Conference",
        )
        ...
        assert result.mentions_found == 1
        mentions = mock_bulk.call_args[0][1]
        assert mentions[0].mention_text == "Moreau Obrador"
    ...
    async def test_progress_callback_invoked(self) -> None:
        ...
        entity_id = _make_uuid()
        entity = _make_entity_row(entity_id=entity_id, canonical_name="Ada Lovelace")
        video = _make_video_row(video_id="vid00900009", title="Ada Lovelace Talk")
...
class TestScanMetadataDescription:
    ...
    async def test_t021_description_scan_creates_mentions_with_context(
        ...
        entity = _make_entity_row(entity_id=entity_id, canonical_name="Ada Lovelace")
        description_text = (
            "In this interview, Ada Lovelace discusses the future of linguistics "
    ...
    async def test_t023_mention_context_75_chars_before_and_after(self) -> None:
        ...
        assert "Ada Lovelace" in snippet
    ...
    async def test_t023_context_no_leading_ellipsis_at_start(self) -> None:
        ...
        text = "Ada Lovelace discusses linguistics and more content after."
        match_start = 0
        match_end = 12
    ...
    async def test_t023_context_no_trailing_ellipsis_at_end(self) -> None:
        ...
        text = "Some text about Ada Lovelace"
        match_start = text.index("Ada Lovelace")
        match_end = match_start + len("Ada Lovelace")
    ...
    async def test_t024_very_long_description_processes_without_error(
        ...
        long_desc = "x" * 5000 + " Ada Lovelace " + "y" * 5000
    ...
    async def test_description_scan_multiple_distinct_matches(self) -> None:
        ...
        entity = _make_entity_row(entity_id=entity_id, canonical_name="Ada Lovelace")
        description = (
            "Ada Lovelace was interviewed about his work. "
            "Later, Ada Lovelace discussed the implications."
        )
        video = _make_video_row(
    ...
    async def test_description_scan_applies_exclusion_patterns(self) -> None:
        ...
        video = _make_video_row(
            ...
            title="Some Title",
            description="Great vacation spots in New Peru and surrounding areas.",
        )
...
class TestScanMetadataCombined:
    ...
    async def test_combined_title_and_description_scan(self) -> None:
        ...
        video = _make_video_row(
            ...
            title="Ada Lovelace Interview",
            description="In this video, Ada Lovelace talks about AI.",
        )
