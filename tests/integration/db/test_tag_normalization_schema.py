...
class TestUniqueConstraints:
    ...
    async def test_named_entity_duplicate_canonical_name_and_type(
        ...
        entity1 = NamedEntity(
            id=uuid7(),
            canonical_name="Peru City",
            canonical_name_normalized="peru city",
            entity_type="place",
            discovery_method="manual",
            confidence=1.0,
            status="active",
        ...
        entity2 = NamedEntity(
            id=uuid7(),
            canonical_name="PERU CITY",  # Different case
            canonical_name_normalized="peru city",  # Same normalized
...
class TestCascadeDelete:
    ...
    async def test_delete_named_entity_cascades_to_entity_aliases(
        ...
        entity = NamedEntity(
            id=entity_id,
            canonical_name="Peru",
            canonical_name_normalized="peru",
            entity_type="place",
            discovery_method="manual",
            confidence=1.0,
            status="active",
