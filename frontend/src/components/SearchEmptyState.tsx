      ...
      <div className="flex flex-wrap gap-2 justify-center">
        ...
        {EXAMPLE_QUERIES.map((example) => (
          <button
            ...
            className="px-3 py-1.5 text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
