...
vi.mock('../../src/hooks/useEntityMentions', () => ({
  useWikidataCandidates: vi.fn(),
}));

vi.mock('../../src/hooks/useRegroundEntity', () => ({
...
import { EntityEnrichmentSection } from '../../src/components/entity/EntityEnrichmentSection';
import type { EntityEnrichmentSectionProps } from '../../src/components/entity/EntityEnrichmentSection';
import { useWikidataCandidates } from '../../src/hooks/useEntityMentions';
import { useRegroundEntity } from '../../src/hooks/useRegroundEntity';
import type { EntityEnrichment, WikidataCandidate } from '../../src/api/entityMentions';
