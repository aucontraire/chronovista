...
def merge_tags(
    ...
    into: str = typer.Option(
        ..., "--into", help="Tag name to merge into (e.g., 'Carl Backus')"
    ),
...
def split_tag(
    normalized_form: str = typer.Argument(
        help="Tag name to split (e.g., 'Carl Backus')."
    ),
...
def rename_tag(
    normalized_form: str = typer.Argument(
        help="Tag name to rename (e.g., 'Carl Backus')."
    ),
    to: str = typer.Option(
...
def deprecate_tag(
    normalized_form: Optional[str] = typer.Argument(
        None, help="Tag name to deprecate (e.g., 'Carl Backus')."
    ),
...
def classify_tag(
    normalized_form: Optional[str] = typer.Argument(
        None, help="Tag name to classify (e.g., 'Carl Backus')."
    ),
