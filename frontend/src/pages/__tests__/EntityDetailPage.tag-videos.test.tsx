...
function createTranscriptVideo(overrides: Partial<EntityVideoResult> = {}): EntityVideoResult {
  return {
    ...
    mention_count: 3,
    mentions: [
      { segment_id: 42, start_time: 120.0, mention_text: "Karen Sparck" },
    ],
    sources: ["transcript"],
    has_manual: false,
...
function createMixedSourceVideo(overrides: Partial<EntityVideoResult> = {}): EntityVideoResult {
  return {
    ...
    mention_count: 2,
    mentions: [
      { segment_id: 55, start_time: 60.0, mention_text: "Karen Sparck" },
    ],
      ...
      vi.mocked(useEntityVideos).mockReturnValue({
        ...
        videos: [
          createTranscriptVideo({
            video_id: "transcript-vid-001",
            mentions: [{ segment_id: 42, start_time: 120.0, mention_text: "Karen Sparck" }],
            first_mention_time: 120.0,
          }),
        ],
        total: 1,
      ...
      vi.mocked(useEntityVideos).mockReturnValue({
        ...
        videos: [
          createMixedSourceVideo({
            video_id: "mixed-vid-001",
            mentions: [{ segment_id: 55, start_time: 60.0, mention_text: "Karen Sparck" }],
            first_mention_time: 60.0,
          }),
        ],
        total: 1,
