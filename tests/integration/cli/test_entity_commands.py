...
class TestCreateEntityCommand:
    ...
    def test_create_entity_person_exit_code_zero(self) -> None:
        ...
        with (
            ...
            result = runner.invoke(
                app, ["entities", "create", "Ada Lovelace", "--type", "person"]
            )
    ...
    def test_create_entity_auto_title_cases_name(self) -> None:
        ...
        mock_entity = _make_mock_entity(name="Ada Lovelace")
        ...
        with (
            ...
            result = runner.invoke(
                app,
                ["entities", "create", "ada lovelace", "--type", "person"],
            )
        ...
        assert obj_in.canonical_name == "Ada Lovelace"
    ...
    def test_create_entity_missing_type_flag_exits_nonzero(self) -> None:
        ...
        result = runner.invoke(app, ["entities", "create", "Ada Lovelace"])
...
class TestListEntitiesCommand:
    ...
    def test_list_entities_shows_table_with_entity_names(self) -> None:
        ...
        entity1 = _make_mock_entity(name="Ada Lovelace")
        entity2 = _make_mock_entity(name="Arthur Wells", entity_type="person")
        ...
        assert "Ada Lovelace" in result.output
        assert "Arthur Wells" in result.output
...
class TestBackfillDescriptionsCommand:
    ...
    def test_backfill_dry_run_shows_preview(self) -> None:
        ...
        mock_entity_1.canonical_name = "Edith Clarke"
        ...
        mock_entity_2.canonical_name = "Ada Lovelace"
...
class TestAddAliasCommand:
    ...
    def test_add_alias_output_shows_entity_name_and_count(self) -> None:
        ...
        mock_entity = _make_mock_entity(name="Renée Dubois")
        ...
        assert result.exit_code == 0, f"Output: {result.output}"
        assert "Renée Dubois" in result.output
